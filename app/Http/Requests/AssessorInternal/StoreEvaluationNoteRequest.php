...
class StoreEvaluationNoteRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'assignment_id.required' => 'Assignment harus dipilih.',
            'assignment_id.exists' => 'Assignment yang dipilih tidak ditemukan.',
            'document_id.exists' => 'Dokumen yang dipilih tidak ditemukan.',
