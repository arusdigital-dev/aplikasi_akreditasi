...
export default function Login() {
    ...
    return (
        <>
            <Head title="Login" />
            <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4" style={{ fontFamily: 'Poppins, system-ui, sans-serif' }}>
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-semibold text-[#0f172a]">Masuk ke Akun</h1>
                        <p className="text-sm text-[#64748b] mt-2">Gunakan akun UMRAH Anda untuk login</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-[#e2e8f0] p-8">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="remember" className="ml-2 text-sm text-[#64748b]">
                                        Ingat saya
                                    </label>
                                </div>
                            </div>
                        ...
                        <div className="mt-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-2 bg-white text-[#64748b]">atau</span>
                                </div>
                            </div>

                            <a
                                href="/auth/google"
                                className="mt-4 w-full flex items-center justify-center gap-3 rounded-lg border border-[#e2e8f0] bg-white px-4 py-2.5 text-sm font-medium text-[#0f172a] hover:bg-[#f8fafc] transition-colors"
                            >
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-[#64748b]">
                                Belum punya akun?{' '}
                                <Link href="/register" className="text-[#2563EB] hover:text-[#1E4ED0] font-medium">
                                    Daftar sekarang
                                </Link>
                            </p>
                        </div>
