...
interface Employee {
    ...
    tmt_jabatan_fungsional: string | null;
    kum: number | null;
...
export default function EmployeesEdit({ employee, units, roles }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        management_position: employee.management_position || '',
        jabatan_struktural: employee.jabatan_struktural || '',
        jabatan_fungsional: employee.jabatan_fungsional || '',
        pangkat: employee.pangkat || '',
        golongan: employee.golongan || '',
        tmt_golongan: employee.tmt_golongan || '',
        tmt_jabatan_fungsional: employee.tmt_jabatan_fungsional || '',
        kum: employee.kum?.toString() || '',
        education_level: employee.education_level || '',
        status_keaktifan: employee.status_keaktifan || 'Aktif',
        role_id: employee.role_assignments?.[0]?.role?.id || '',
        additional_notes: '',
    });
    ...
    return (
        <>
            ...
            <DashboardLayout title="Edit Pegawai" subtitle={`Edit data pegawai: ${employee.name}`}>
